...
clf = ak.ImageClassifier(
    ...
    #loss=None,
    #metrics=None,
    project_name="autokeras-cifar100-v2",
    max_trials=100,
    #directory=None,
    objective="val_accuracy",
    tuner='bayesian', #'greedy', 'bayesian', 'hyperband' or 'random'
    #seed=None,
    max_model_size=25000000,
    overwrite=False
    )
...
callbacks = [
                ...
                CSVLogger('autokeras-cifar100-v2/log-maxtrail150.csv', separator=",", append=True)
...
print(best.summary())
best.save("autokeras-cifar100-v2-best.h5")
...
try:
    ...
    with open('autokeras-cifar100-v2_best_hp.txt', 'w') as f:
